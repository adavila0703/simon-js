...
let audioPaths = ['sounds/green.mp3', 'sounds/red.mp3', 'sounds/yellow.mp3', 'sounds/blue.mp3']
...
function simonSays(){
    let audio = new Audio(audioPaths[aiArray[aiArray.length - 1]]);
    console.log(audioPaths[aiArray[aiArray.length - 1]])
    audio.play();
